...
Implement the Depth of Field effect.

For this purpose, implement ray creation based on the thin lens model in
\code{Camera::getRay()} as discussed in the lecture.

The tutorial material includes the example scene from the lecture.
